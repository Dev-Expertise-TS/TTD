            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <p className="text-sm text-green-700">
                    Cancel up to 24 hours before the experience starts and get a full refund.
                  </p>
                </div>
                ...
                <div className="p-4 bg-amber-50 rounded-lg border border-amber-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-amber-800">Partial Refund</h4>
                  </div>
                  <p className="text-sm text-amber-700">
                    Cancel between 12-24 hours before the experience starts and get a 50% refund.
                  </p>
                </div>
                ...
                <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-red-800">No Refund</h4>
                  </div>
                  <p className="text-sm text-red-700">
                    No refund if you cancel less than 12 hours before the experience starts.
                  </p>
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  ...
                  <li>
                    • Weather-related cancellations by the operator will receive a full refund or rescheduling option.
                  </li>
                  <li>• No-show policy: Failure to show up without prior notice will result in no refund.</li>
                  <li>• To cancel your booking, please contact us at support@tourvis.com or call +1 (555) 123-4567.</li>
                </ul>
              </div>
            </div>
          </CardContent>
